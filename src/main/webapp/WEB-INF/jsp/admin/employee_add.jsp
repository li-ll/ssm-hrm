							...
							<div class="form-group">
								...
								<div class="col-sm-7">
									<div class="radio i-checks">
                                        <label>
                                            <input type="radio" value="男" name="gender" checked="checked"required> <i></i>男</label>
                                        <i style="margin-left: 25px"></i>
                                        <label>
                                            <input type="radio" value="女" name="gender"required> <i></i>女</label>
                                    </div>
								</div>
							</div>
							<div class="form-group">
